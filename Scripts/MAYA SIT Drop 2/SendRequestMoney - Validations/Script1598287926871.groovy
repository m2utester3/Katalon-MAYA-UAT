...
not_run: Mobile.tap(findTestObject('MAYA Drop 2/SendRequestMoney-Validations/android.widget.TextView0 - Maybank2u'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/SendRequestMoney-Validations/android.widget.TextView0 - Enter your 6-digit PIN'), 
    0)

not_run: Mobile.tap(findTestObject('MAYA Drop 2/SendRequestMoney-Validations/android.widget.ImageView0'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/SendRequestMoney-Validations/android.widget.TextView0 - Maybank2u'), 
    0)
...
not_run: Mobile.getText(findTestObject('MAYA Drop 2/SendRequestMoney-Validations/android.widget.TextView0 - 60127845015 (1)'), 
    0)
...
Mobile.verifyEqual(var23, 'Request marked as paid.')

not_run: Mobile.tap(findTestObject('MAYA Drop 2/SendRequestMoney-Validations/android.widget.ImageView0 (10)'), 0)
