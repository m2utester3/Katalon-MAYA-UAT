...
Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/41.png', FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: Mobile.getText(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT Tabung Tab to View'), 0)

Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/42.png', FailureHandling.CONTINUE_ON_FAILURE)

'group'
if (Mobile.verifyElementExist(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT Tabung Tab to View'), 0)) {
    Mobile.tap(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT Tabung Tab to View'), 0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/43.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/44.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/45.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/46.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung Tap to select start date'), 0)

    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/47.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung start month'), 0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/48.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung Change name after date'), 0)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung Change name after date'), 0)

    Mobile.setText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung SET chnage name after date'), 'GROUP MOSAJ', 
        0)

    WebUI.delay(2)

    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/49.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.TextView0 - RM (5)'), 0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.EditText0 - 2089 (2)'), 0)

    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.ImageView0 (9)'), 0)

    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.ImageView0 (9)'), 0)

    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.TextView0 - 2 (3)'), 0)

    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.TextView0 - 2 (3)'), 0)

    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.ImageView0 (10)'), 0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/50.png', FailureHandling.CONTINUE_ON_FAILURE)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung PLUS sign'), 0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/51.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/52.png', FailureHandling.CONTINUE_ON_FAILURE)

    not_run: Mobile.tapAtPosition(width * 0.46296, height * 0.81875)

    Mobile.tapAtPosition(width * 0.48148, height * 0.54687)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - Group 14 frineds'), 0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - Group 24 frineds'), 0)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - Group AMOUNT frnd 2'), 0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - Group AMOUNT frnd 2 value'), 
        0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - Group AMOUNT CONTINUE'), 0)

    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/53.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/54.png', FailureHandling.CONTINUE_ON_FAILURE)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 16'), 0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 17'), 0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/55.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/56.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung OTP header'), 0)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung OTP header - Confirm'), 0)

    def otpTabungCreate = Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung OTP Value'), 
        0)
    ...
    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung OTP OK btn'), 0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/57.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 6'), 
        0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/58.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/59.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/60.png', FailureHandling.CONTINUE_ON_FAILURE)

    Mobile.swipe(500, 1700, 500, 400)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/61.png', FailureHandling.CONTINUE_ON_FAILURE)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 32'), 
        0)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 36'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 37'), 
        0)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 39'), 
        0)

    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 37'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 40'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 41'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 42'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 43'), 
        0)

    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 43'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 45'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 46'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 47'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 48'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 49'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 50'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 51'), 
        0)

    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 51'), 
        0)
...
Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/62.png', FailureHandling.CONTINUE_ON_FAILURE)
