...
Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/1.png', FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/2.png', FailureHandling.CONTINUE_ON_FAILURE)
...
if (Mobile.verifyElementExist(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT Tabung Tab to View'), 0)) {
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/3.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/4.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/5.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/6.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/7.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/8.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/9.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/10.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/11.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung select start date 1'), 0)

    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/12.png', FailureHandling.CONTINUE_ON_FAILURE)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung select start date 1'), 0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/13.png', FailureHandling.CONTINUE_ON_FAILURE)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.TextView0 - Next (1)'), 0)

    WebUI.delay(3)

    Mobile.setText(findTestObject('MAYA Drop 2/PayBills-Jompay/android.widget.EditText0'), 'Pass@1278', 0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/14.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.setText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung SET chnage name after date'), 'TABUNG MOSAJ', 
        0)

    WebUI.delay(2)

    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/15.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/16.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/17.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/18.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/19.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/20.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/21.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tanung - CONTINUE'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 1'), 0)

    WebUI.delay(5)

    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/22.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/23.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/24.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/25.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung OTP header'), 0)

    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung OTP header - Confirm'), 0)

    not_run: Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/26.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung OTP OK btn'), 0)
    ...
    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 7 - IND MOSAJ'), 
        0)

    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/27.png', FailureHandling.CONTINUE_ON_FAILURE)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 7 - IND MOSAJ'), 
        0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 8'), 
        0)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/28.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/29.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/30.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/31.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/32.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/33.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung SUCCESS msg'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung SUCCESS refid'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung SUCCESS refid value'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung SUCCESS datetime'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung SUCCESS date value'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung SUCCESS DONE'), 0)

    Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/34.png', FailureHandling.CONTINUE_ON_FAILURE)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy UAT/UAT - Tabung SUCCESS DONE'), 0)
...
not_run: Mobile.verifyElementExist(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - Tap to view'), 
    0)

not_run: if (Mobile.verifyElementExist(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT Tabung Tab to View'), 0)) {
    Mobile.tap(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT Tabung Tab to View'), 0)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.TextView0 - Select Start Date'), 
        0)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.EditText0 - Tabung (3)'), 0)
...
Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/35.png', FailureHandling.CONTINUE_ON_FAILURE)
