...
Mobile.tap(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT - Wallet'), 0)
...
not_run: Mobile.getText(findTestObject('MAYA Wallet spending/android.widget.TextView0 - Savings Account'), 0)

not_run: Mobile.getText(findTestObject('MAYA Wallet spending/android.widget.TextView0 - 1140 1382 3409'), 0)
...
Mobile.tap(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT - Wallet expenses JUN'), 0)

Mobile.getText(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT - Wallet - this months spending'), 0)
...
Mobile.setText(findTestObject('MAYA Wallet spending/android.widget.EditText0'), 'Pass@1278', 0)
...
not_run: Mobile.tap(findTestObject('MAYA Wallet spending/wallet part 2/android.widget.ImageView0'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA Wallet spending/wallet part 2/android.widget.ImageView0 (3)'), 0)
