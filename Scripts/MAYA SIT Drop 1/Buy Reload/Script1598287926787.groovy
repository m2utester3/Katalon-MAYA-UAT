...
Mobile.setText(findTestObject('MAYA SIT Regression SPY/UAT - Reload SET PWD'), 'ptesting01', 0)
...
not_run: REJECT = Mobile.getText(findTestObject('MAYA SIT Regression SPY/reload OTA reject button'), 0)

not_run: Mobile.verifyEqual(REJECT, 'Reject')

not_run: Mobile.tap(findTestObject('MAYA SIT Regression SPY/reload OTA reject button'), 0)
