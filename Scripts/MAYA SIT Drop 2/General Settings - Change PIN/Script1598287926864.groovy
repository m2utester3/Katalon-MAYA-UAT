...
not_run: Mobile.tap(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Manage Devices'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Manage Devices (1)'), 
    0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - You can only have a maximum of 3 registered devices'), 
    0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Samsung Galaxy S7'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Registered on 04 May 2020'), 
    0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Current'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - SM-G930F'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Registered on 16 Apr 2020'), 
    0)

not_run: Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/SettingsChangePIN/12.png', FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.tap(findTestObject('MAYA Drop 2/General Settings 2/android.widget.ImageView0 (6)'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Remove Device'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Are you sure want to remove SM-G930F'), 
    0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Cancel (2)'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Proceed'), 0)

not_run: Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/SettingsChangePIN/13.png', FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.tap(findTestObject('MAYA Drop 2/General Settings 2/android.widget.ImageView0 (7)'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA Drop 2/General Settings 2/android.widget.ImageView0 (8)'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Cancel (2)'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA Drop 2/General Settings 2/android.widget.ImageView0 (9)'), 0)
