...
def otpJompay = Mobile.getText(findTestObject('MAYA Drop 2/Forgot M2U Login/spy/Fortgot Login - OTP number'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA Drop 2/PayBills-Jompay/spy/UAT - Bills TAC OK btn'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.setText(findTestObject('MAYA drop 2 SPY/jompay - paybills - biller SET TEXT'), 'Maxis Mobile', 0)
...
not_run: Mobile.getText(findTestObject('MAYA Drop 2/PayBills-Jompay/android.widget.TextView0 - Tenaga Nasional Berhad (1)'), 
    0)
